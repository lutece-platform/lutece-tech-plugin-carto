...
insert into carto_data_layer_type(title, editable, searchable_by_others, inclusion, exclusion) values ('éditable par les usagers et consultable par tous les usagers',1,1,0,0);
